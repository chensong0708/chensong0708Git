...
<link href="__ROOT__/public/dwz/themes/default/style.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="__ROOT__/public/dwz/themes/css/core.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="__ROOT__/public/dwz/themes/css/print.css" rel="stylesheet" type="text/css" media="print"/>
<link href="__ROOT__/public/dwz/uploadify/css/uploadify.css" rel="stylesheet" type="text/css" media="screen"/>
<!--[if IE]>
...
<![endif]-->
<script src="__ROOT__/public/dwz/js/jquery-1.7.2.min.js" type="text/javascript"></script>
<script src="__ROOT__/public/dwz/js/jquery.cookie.js" type="text/javascript"></script>
<script src="__ROOT__/public/dwz/js/jquery.validate.js" type="text/javascript"></script>
<script src="__ROOT__/public/dwz/js/jquery.bgiframe.js" type="text/javascript"></script>
<script src="__ROOT__/public/dwz/xheditor/xheditor-1.1.14-zh-cn.min.js" type="text/javascript"></script>
<script src="__ROOT__/public/dwz/uploadify/scripts/jquery.uploadify.min.js" type="text/javascript"></script>

<script src="__ROOT__/public/dwz/bin/dwz.min.js" type="text/javascript"></script>
<script src="__ROOT__/public/dwz/js/dwz.regional.zh.js" type="text/javascript"></script>
...
//		loginUrl:"login.html",	// 跳到登录页面
		...
		callback:function(){
			initEnv();
			$("#themeList").theme({themeBase:"__ROOT__/public/dwz/themes"});
...
<body scroll="no">
	<div id="layout">
		<div id="header">
			...
			<div id="navMenu">
				<ul>
					<li ><a href="sidebar_1.html"><span>资讯管理</span></a></li>
		...
		<div id="leftside">
			...
			<div id="sidebar">
				<div class="toggleCollapse"><h2>主菜单</h2><div>展开</div></div>
				...
				<div class="navTab-panel tabsPageContent layoutBox">
					<div class="page unitBox">
						<div class="accountInfo">
							<p><span>SuchCMSSuchCMSSuchCMSSuchCMSSuchCMS</span></p>
						</div>
